<?php
/**
	* @name   : Takien Easy Options
	* @author : takien
	* @version: 1.1
	* @link   : http://takien.com
	* add array_replace_recursive
	* 
 */
defined('ABSPATH') or die();

if(!class_exists('WPSpryMenuOptions')) {
	class WPSpryMenuOptions {
	...
	<div class="wrap">
		...
		<?php } ?>
		<?php
			apply_filters('easy_option_'.$this->option_menu_slug.'_before_form','');
		?>
		...
		<?php 
			apply_filters('easy_option_'.$this->option_menu_slug.'_after_form','');
		?>
		<?php /*<p>
...
/**
 *
 * array_replace_recursive if not exists
 *
 *
 *
 */
